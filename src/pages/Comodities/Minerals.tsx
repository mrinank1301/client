...
function Minerals() {
  ...
  return (
    <div>
        ...
        <Hero2
      backgroundImage="/minerals-hero.svg"
      tagline=""
      heading="Global Sourcing of Premium Industrial Minerals"
      subheading="Iron Ore, Bauxite, and Manganese from the world's top mining regions."
      />
      ...
      <motion.header 
        ...
        variants={fadeInUp}
      >
        <h1 className="text-3xl md:text-4xl font-bold mb-2">About Our Mineral Offerings</h1>
        <p className="text-gray-600">Quality minerals sourced globally for your industrial needs</p>
      </motion.header>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <motion.div className="text-center shadow-md p-8 rounded-lg" variants={fadeInUp}>
            ...
            <p className="text-sm text-gray-600">
              Rigorous testing and quality control measures ensure our minerals meet international standards.
            </p>
          </motion.div>
      ...
      >
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold mb-2">Top Mineral Products</h2>
            <p className="text-gray-600">Premium industrial minerals sourced from trusted mines worldwide</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            >
              <Card className="overflow-hidden">
                <div className="h-48 overflow-hidden bg-gray-200">
                  <img src="/iron.svg" alt="Iron Ore Fines" className="w-full h-full object-cover" />
                </div>
                <div className="p-4">
                  <h3 className="font-bold text-lg mb-4">Iron Ore Fines 62%</h3>
                  
                  <div className="grid grid-cols-2 gap-2 text-sm">
                    <div className="font-medium">Grade:</div>
                    <div className="text-right">62% Fe</div>
                    
                    <div className="font-medium">Usage:</div>
                    <div className="text-right">Steelmaking</div>
                    
                    <div className="font-medium">Size:</div>
                    <div className="text-right">0-10 mm</div>
            ...
            >
              <Card className="overflow-hidden">
                <div className="h-48 overflow-hidden bg-gray-200">
                  <img src="/calcined.svg" alt="Calcined Bauxite" className="w-full h-full object-cover" />
                </div>
                <div className="p-4">
                  <h3 className="font-bold text-lg mb-4 ">Calcined Bauxite</h3>
                  
                  <div className="grid grid-cols-2 gap-2 text-sm">
                    <div className="font-medium">Grade:</div>
                    <div className="text-right">Al₂O₃ 80-85%</div>
                    
                    <div className="font-medium">Usage:</div>
                    <div className="text-right">Refractories, Abrasives</div>
                    
                    <div className="font-medium">Size:</div>
                    <div className="text-right">0-30 mm</div>
                    
                    <div className="font-medium">Packaging:</div>
                    <div className="text-right">Bulk/Containerized</div>
                  </div>
                </div>
              </Card>
            </motion.div>
            ...
            >
              <Card className="overflow-hidden">
                <div className="h-48 overflow-hidden bg-gray-200">
                  <img src="/manganese.svg" alt="Manganese Ore" className="w-full h-full object-cover" />
                </div>
                <div className="p-4">
                  <h3 className="font-semibold text-lg mb-4">Manganese Ore</h3>
                  
                  <div className="grid grid-cols-2 gap-2 text-sm">
                    <div className="font-medium">Grade:</div>
                    <div className="text-right">Mn 42-44%</div>
                    
                    <div className="font-medium">Usage:</div>
                    <div className="text-right">Steel & Battery Production</div>
                    
                    <div className="font-medium">Size:</div>
                    <div className="text-right">10-100 mm</div>
                    
                    <div className="font-medium">Origin:</div>
                    <div className="text-right">South Africa, Brazil</div>
                  </div>
                </div>
              </Card>
            </motion.div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <motion.div
              ...
              variants={fadeInUp}
            >
              <h2 className="text-2xl font-bold mb-6">Mineral Inquiry Form</h2>
                  ...
                  <div>
                    ...
                    <Select>
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="bauxite">Calcined Bauxite</SelectItem>
                        <SelectItem value="manganese">Manganese Ore</SelectItem>
