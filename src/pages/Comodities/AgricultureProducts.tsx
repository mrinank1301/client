...
function AgricultureProducts() {
  ...
  return (
    <div>
        ...
        <Hero2
      backgroundImage="/agri-hero.svg"
      tagline=""
      heading="Global Export of High QualityAgriculturalCommodities"
      subheading="Rice, Wheat, Pulses, and Spices delivered from farm to port."
      />
      ...
      <motion.header 
        ...
        variants={fadeInUp}
      >
        <h1 className="text-3xl md:text-4xl font-bold mb-2">About Our Agriculture Offerings</h1>
        <p className="text-gray-600">Quality agriculture products sourced globally for your industrial needs</p>
      </motion.header>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <motion.div className="text-center shadow-md p-8 rounded-lg" variants={fadeInUp}>
            ...
            <p className="text-sm text-gray-600">
              Rigorous testing and quality control measures ensure our agriculture products meet international standards.
            </p>
          </motion.div>
          ...
          <motion.div className="text-center shadow-md p-8 rounded-lg" variants={fadeInUp}>
            ...
            <p className="text-sm text-gray-600">
              Strategic partnerships with farms across continents ensure consistent supply regardless of market fluctuations.
            </p>
          </motion.div>
      ...
      >
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold mb-2">Top Agriculture Products</h2>
            <p className="text-gray-600">Premium quality agricultural commodities sourced from the world's best farming regions.</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            >
              <Card className="overflow-hidden">
                <div className="h-48 overflow-hidden bg-gray-200">
                  <img src="/basmati.svg" alt="Basmati Rice" className="w-full h-full object-cover" />
                </div>
                <div className="p-4">
                  <h3 className="font-bold text-lg mb-4">Basmati Rice</h3>
                  
                  <div className="grid grid-cols-2 gap-2 text-sm">
                    <div className="font-medium">Type:</div>
                    <div className="text-right">Long Rice aromatic rice</div>
                    
                    <div className="font-medium">Moisture:</div>
                    <div className="text-right">&lt;13%</div>
                    
                    <div className="font-medium">Packaging:</div>
                    <div className="text-right">25kg / 50kg PP bags</div>
                    
                    <div className="font-medium">Usage:</div>
                    <div className="text-right">Cooking, Exports, Hospitality</div>
                  </div>
                </div>
              </Card>
            </motion.div>
            ...
            >
              <Card className="overflow-hidden">
                <div className="h-48 overflow-hidden bg-gray-200">
                  <img src="/wheat.svg" alt="Wheat Flour" className="w-full h-full object-cover" />
                </div>
                <div className="p-4">
                  <h3 className="font-bold text-lg mb-4 ">Wheat Flour</h3>
                  
                  <div className="grid grid-cols-2 gap-2 text-sm">
                    <div className="font-medium">Grade: </div>
                    <div className="text-right">Refined or Whole</div>
                    
                    <div className="font-medium">Gluten:</div>
                    <div className="text-right">8–12%</div>
                    
                    <div className="font-medium">Packaging: </div>
                    <div className="text-right">Bulk / Retail packs</div>
                    
                    <div className="font-medium">Usage:</div>
                    <div className="text-right">Bakery, Household, Industrial</div>
                  </div>
                </div>
              </Card>
            </motion.div>
            ...
            >
              <Card className="overflow-hidden">
                <div className="h-48 overflow-hidden bg-gray-200">
                  <img src="/turmeric.svg" alt="Turmeric" className="w-full h-full object-cover" />
                </div>
                <div className="p-4">
                  <h3 className="font-semibold text-lg mb-4">Turmeric (Whole & Powder)</h3>
                  
                  <div className="grid grid-cols-2 gap-2 text-sm">
                    <div className="font-medium">Curcumin:</div>
                    <div className="text-right">3–5%</div>
                    
                    <div className="font-medium">Origin:</div>
                    <div className="text-right">India</div>
                    
                    <div className="font-medium">Usage:</div>
                    <div className="text-right">Food processing, Medicinal</div>
                    
                    <div className="font-medium">Packaging:</div>
                    <div className="text-right">25kg bags or customized</div>
                  </div>
                </div>
              </Card>
            </motion.div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <motion.div
              ...
              variants={fadeInUp}
            >
              <h2 className="text-2xl font-bold mb-6">Agriculture Inquiry Form</h2>
