...
const navItems = [
  ...
  { name: 'PAGES', href: '#about', dropdown: true, items: [
    { name: 'Company History', href: '#' },
    { name: 'Our Team', href: '#team' },
    { name: 'FAQ', href: '#faq' },
  ]},
  { name: 'SERVICES', href: '#services', dropdown: false },
  { name: 'BLOG', href: '#blog', dropdown: true, items: [
...
const Navbar: React.FC = () => {
  ...
  return (
    <header className={cn(
      'fixed w-full top-0 left-0 z-50 transition-all duration-300 px-4 lg:px-10',
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="hidden lg:flex items-center space-x-6">
          ...
          <div className="relative">
            <span className="absolute -top-2 -right-2 w-5 h-5 bg-primary text-white text-xs flex items-center justify-center rounded-full">0</span>
      ...
      {/* Mobile Menu */}
      <div className={cn(
        "lg:hidden fixed inset-0 bg-white z-40 transition-transform duration-300 pt-20",
