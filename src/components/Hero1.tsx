  ...
  return (
    ...
    >
      ...
      <div className="relative container-custom h-full flex flex-col justify-end py-20 mt-14">
        <div className="flex flex-col gap-4 pb-10 md:flex-row md:gap-6 items-center">
          ...
          <div className={cn(
            "flex flex-col items-start gap-6 mt-8 transition-all transform",
            isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"
          )}
          style={{ transitionDuration: `${animationDuration}ms` }}
          >
            ...
            <div className="block mt-6 md:mt-0 md:ml-40">
