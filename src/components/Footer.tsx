...
const Footer: React.FC = () => {
  return (
    <footer className="bg-secondary-dark text-white pt-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 pb-12">
          <div>
            ...
            <p className="text-gray-300 mb-6">
              Your trusted partner for all logistics and shipping needs. We deliver your goods safely and efficiently across the globe.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start">
                ...
                <span className="text-gray-300">123 Logistics Avenue, Shipping District, NY 10001, USA</span>
              </li>
      ...
      <div className="border-t border-gray-800 py-6">
        <div className="container-custom flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400">© 2023 Deliver Logistics. All rights reserved.</p>
          <div className="mt-4 md:mt-0 flex space-x-6">
            <a href="#" className="text-gray-400 hover:text-white transition-colors">Privacy Policy</a>
            <a href="#" className="text-gray-400 hover:text-white transition-colors">Terms of Service</a>
            <a href="#" className="text-gray-400 hover:text-white transition-colors">Cookies Settings</a>
          </div>
        </div>
      </div>
    </footer>
